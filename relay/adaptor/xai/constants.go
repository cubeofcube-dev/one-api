...
var ModelRatios = map[string]adaptor.ModelConfig{
	...
	"grok-code-fast-1":          {Ratio: 0.2 * ratio.MilliTokensUsd, CompletionRatio: 1.5, CachedInputRatio: 0.02 * ratio.MilliTokensUsd},        // $0.20 input, $0.02 cached input, $1.50 output
	...
	"grok-4-fast-reasoning":     {Ratio: 0.2 * ratio.MilliTokensUsd, CompletionRatio: 0.5, CachedInputRatio: 0.05 * ratio.MilliTokensUsd},        // $0.20 input, $0.05 cached input, $0.50 output
	"grok-4-fast":               {Ratio: 0.2 * ratio.MilliTokensUsd, CompletionRatio: 0.5, CachedInputRatio: 0.05 * ratio.MilliTokensUsd},        // $0.20 input, $0.05 cached input, $0.50 output
	"grok-4-fast-non-reasoning": {Ratio: 0.2 * ratio.MilliTokensUsd, CompletionRatio: 0.5, CachedInputRatio: 0.05 * ratio.MilliTokensUsd},        // $0.20 input, $0.05 cached input, $0.50 output
