...
import { useModelAndTokenBrowser, UseModelAndTokenBrowserResult } from './useModelAndTokenBrowser'
import { usePlaygroundParameters, UsePlaygroundParametersResult } from './usePlaygroundParameters'
...
export const usePlaygroundViewModel = (): UsePlaygroundViewModelResult => {
  ...
  const handleCopyMessage = useCallback(async (_index: number, content: string) => {
    try {
