          ...
          render={({ field }) => (
            <FormItem>
              <div className="flex items-center justify-between">
                <LabelWithHelp
                  label={tr('inference_profile.label', 'Inference Profile ARN Map')}
              ...
              <FormControl>
                <Textarea
                  placeholder={tr('inference_profile.placeholder', '{"anthropic.claude-3-5-sonnet-20240620-v1:0": "arn:aws:bedrock:..."}')}
