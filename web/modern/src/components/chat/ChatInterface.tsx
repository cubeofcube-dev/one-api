						...
						<div className="flex items-center justify-between gap-2">
							...
							<div className="hidden sm:flex items-center gap-2">
								<Button
									...
									title={
										focusModeEnabled
											? t("playground.chat.disable_focus")
											: t("playground.chat.enable_focus")
									}
								>
									{focusModeEnabled ? (
						...
						<div className="flex items-start justify-between gap-2 flex-wrap">
							<div className="flex items-start gap-2 min-w-0 flex-1">
								{selectedModel && (
									<div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 min-w-0 flex-1">
										...
										<div className="min-w-0 flex-1">
											...
											>
												<span
													className={`${isMobile ? "break-all" : "truncate"} block`}
												>
													{selectedModel}
												</span>
											</Badge>
								...
								{isStreaming && (
									<Badge
										variant="outline"
										className="animate-pulse border-green-500 text-green-600 text-xs flex-shrink-0 self-start sm:ml-auto"
									>
										<div className="w-1.5 h-1.5 bg-green-500 rounded-full mr-1 animate-pulse"></div>
										{isMobile
											? t("playground.chat.generating_mobile")
              ...
              `}
                    ...
                    `}
									...
									<Button
										...
										disabled={
											(!currentMessage.trim() && attachedImages.length === 0) ||
											!selectedModel ||
											!selectedToken
										}
										size={isMobile || isTablet ? "sm" : "md"}
