			...
			<Card>
				...
				<CardContent className="space-y-3">
					...
					<div className="space-y-1.5">
						<div className="flex items-center justify-between">
							<Label className="text-sm">
								{t("playground.parameters.token.label")}
							</Label>
							{isLoadingTokens && (
										...
										<div className="flex items-center justify-between w-full">
											...
											<Badge variant="outline" className="ml-2 text-xs">
												{token.unlimited_quota
													? t("playground.parameters.token.unlimited")
													: `${Math.floor(token.remain_quota / 1000)}K`}
											</Badge>
										</div>
									</SelectItem>
								))}
					...
					<div className="space-y-1.5">
						<div className="flex items-center justify-between">
							<Label className="text-sm">
								{t("playground.parameters.channel.label")}
							</Label>
							{isLoadingChannels && (
								<div className="flex items-center gap-1 text-xs text-muted-foreground">
									<div className="w-3 h-3 border-2 border-primary/30 border-t-primary rounded-full animate-spin"></div>
						...
						<AutosuggestInput
							...
							placeholder={
								isLoadingChannels
									? t("playground.parameters.channel.loading")
									: t("playground.parameters.channel.placeholder")
							}
						...
						<div className="text-xs text-muted-foreground">
							{selectedChannel
								? t("playground.parameters.channel.showing_associated", {
										channel: channelInputValue || "the selected channel",
									})
					...
					<div className="space-y-1.5">
						<div className="flex items-center justify-between">
							<Label className="text-sm">
								{t("playground.parameters.model.label")}
							</Label>
							{isLoadingModels && (
								<div className="flex items-center gap-1 text-xs text-muted-foreground">
									<div className="w-3 h-3 border-2 border-primary/30 border-t-primary rounded-full animate-spin"></div>
						...
						<div className="text-xs text-muted-foreground">
							{selectedModel
								? t("playground.parameters.model.active", {
										model: modelInputValue || selectedModel,
									})
								: models.length === 0
					...
					<div className="space-y-2">
						<Label className="text-sm font-medium">
							{t("playground.parameters.system_message.label")}
						</Label>
						<Textarea
							value={systemMessage}
							onChange={(e) => onSystemMessageChange(e.target.value)}
							placeholder={t(
								"playground.parameters.system_message.placeholder",
							)}
					...
					<div className="space-y-2">
						<div className="flex justify-between items-center">
							<Label className="text-sm font-medium">
								{t("playground.parameters.max_tokens.label")}
							</Label>
							<Badge variant="outline" className="text-xs px-1.5 py-0.5">
								{maxTokens[0]}
							</Badge>
					...
					{modelCapabilities.supportsTopP === true && (
						<div className="space-y-2">
							<div className="flex justify-between items-center">
								<Label className="text-sm font-medium">
									{t("playground.parameters.top_p.label")}
								</Label>
								<Badge variant="outline" className="text-xs px-1.5 py-0.5">
									{topP[0]}
								</Badge>
					...
					{modelCapabilities.supportsTopK === true && (
						<>
							<div className="space-y-2">
								<div className="flex justify-between items-center">
									<Label className="text-sm font-medium">
										{t("playground.parameters.top_k.label")}
									</Label>
									<Badge variant="outline" className="text-xs px-1.5 py-0.5">
										{topK[0]}
									</Badge>
					...
					{modelCapabilities.supportsFrequencyPenalty === true && (
						<>
							<div className="space-y-2">
								<div className="flex justify-between items-center">
									<Label className="text-sm font-medium">
										{t("playground.parameters.frequency_penalty.label")}
									</Label>
									<Badge variant="outline" className="text-xs px-1.5 py-0.5">
										{frequencyPenalty[0]}
									</Badge>
					...
					{modelCapabilities.supportsPresencePenalty === true && (
						<>
							<div className="space-y-2">
								<div className="flex justify-between items-center">
									<Label className="text-sm font-medium">
										{t("playground.parameters.presence_penalty.label")}
									</Label>
									<Badge variant="outline" className="text-xs px-1.5 py-0.5">
										{presencePenalty[0]}
									</Badge>
					...
					{modelCapabilities.supportsMaxCompletionTokens === true && (
						<>
							<div className="space-y-2">
								<div className="flex justify-between items-center">
									<Label className="text-sm font-medium">
										{t("playground.parameters.max_completion_tokens.label")}
									</Label>
									<Badge variant="outline" className="text-xs px-1.5 py-0.5">
					...
					{modelCapabilities.supportsStop === true && (
						<>
							<div className="space-y-2">
								<Label className="text-sm font-medium">
									{t("playground.parameters.stop_sequences.label")}
								</Label>
								<Input
									value={stopSequences}
									onChange={(e) => onStopSequencesChange(e.target.value)}
									placeholder={t(
										"playground.parameters.stop_sequences.placeholder",
									)}
									className="w-full"
								/>
								<div className="text-xs text-muted-foreground">
					...
					{modelCapabilities.supportsReasoningEffort === true && (
						<>
							<div className="space-y-2">
								<Label className="text-sm font-medium">
									{t("playground.parameters.reasoning_effort.label")}
								</Label>
								<Select
								...
								>
									...
									<SelectContent>
										<SelectItem value="none">
											{t("playground.parameters.reasoning_effort.options.none")}
										</SelectItem>
										<SelectItem value="low">
											{t("playground.parameters.reasoning_effort.options.low")}
										</SelectItem>
										<SelectItem value="medium">
											{t(
												"playground.parameters.reasoning_effort.options.medium",
											)}
										</SelectItem>
										<SelectItem value="high">
											{t("playground.parameters.reasoning_effort.options.high")}
										</SelectItem>
									</SelectContent>
								</Select>
								<div className="text-xs text-muted-foreground">
						...
						<>
							...
							{thinkingEnabled && (
								<div className="space-y-2">
									<div className="flex justify-between items-center">
										<Label className="text-sm font-medium">
											{t("playground.parameters.thinking_budget.label")}
										</Label>
										<Badge variant="outline" className="text-xs px-1.5 py-0.5">
					...
					<div className="space-y-2">
						<div className="flex items-center space-x-2">
							<Checkbox
								...
								onCheckedChange={(checked) =>
									onShowReasoningContentChange(!!checked)
								}
							/>
							<div className="space-y-1 leading-none">
								<Label
