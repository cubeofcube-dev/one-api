			...
			>
				...
				{showPageSizeSelector && onPageSizeChange && (
					...
					>
						...
						>
							{isMobile
								? t("common.pagination.per_page", "Per page:")
								: t("common.pagination.rows_per_page", "Rows per page:")}
						</span>
						<Select
						...
						>
							<SelectTrigger
								aria-label="Rows per page"
								className={cn(isMobile ? "h-8 w-14" : "h-8 w-16")}
							>
								<SelectValue />
							</SelectTrigger>
							<SelectContent>
			...
			{totalPages > 1 && (
				...
				>
					...
					{!isMobile && (
						...
						>
							...
							<span className="sr-only">
								{t("common.pagination.first_page", "First page")}
							</span>
						</Button>
					)}
					...
					>
						...
						<span className="sr-only">
							{t("common.pagination.previous_page", "Previous page")}
						</span>
					</Button>

					{/* Page numbers */}
					{pageNumbers.map((page, index) => (
						// biome-ignore lint/suspicious/noArrayIndexKey: page numbers list is transient
					...
					>
						...
						<span className="sr-only">
							{t("common.pagination.next_page", "Next page")}
						</span>
					</Button>
					...
					{!isMobile && (
						...
						>
							...
							<span className="sr-only">
								{t("common.pagination.last_page", "Last page")}
							</span>
						</Button>
					)}
				</div>
