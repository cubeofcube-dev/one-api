	...
	return (
		<ResponsiveContainer maxWidth="7xl" padding="md" className={className}>
			...
			{(title || description || actions || breadcrumbs) && (
				<div className={cn("mb-6", isMobile ? "space-y-4" : "space-y-2")}>
					{breadcrumbs && (
...
export function ResponsiveSection({
	...
	return (
		<div className={cn(variantClasses[variant], className)}>{content}</div>
	);
}
...
export function ResponsiveDivider({
	...
	return (
		<hr className={cn("border-border", spacingClasses[spacing], className)} />
	);
}
