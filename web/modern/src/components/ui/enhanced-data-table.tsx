...
export function EnhancedDataTable<TData, TValue>({
	...
	const effectiveEmptyMessage =
		emptyMessage || t("common.no_data", "No results found.");

	// Floating actions state
	const [hoveredRowData, setHoveredRowData] = React.useState<TData | null>(
		null,
	);
	...
	return (
		<div className={cn("space-y-4", className)}>
			...
			{floatingRowActions &&
				...
				floatingPos &&
				createPortal(
					// biome-ignore lint/a11y/noStaticElementInteractions: floating actions need mouse events
					<div
