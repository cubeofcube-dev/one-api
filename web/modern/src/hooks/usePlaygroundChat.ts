...
import { UsePlaygroundChatProps, UsePlaygroundChatReturn } from './usePlaygroundChat/types'
...
export function usePlaygroundChat(props: UsePlaygroundChatProps): UsePlaygroundChatReturn {
  const {
    selectedToken,
    selectedModel,
    messages,
