      ...
      <Stack spacing={2}>
        ...
        <SubCard
          ...
          subTitle={
            <span>
              用以支持通过微信进行登录注册，
              <a href="https://github.com/cubeofcube-dev/wechat-server" target="_blank" rel="noopener noreferrer">
                点击此处
              </a>
              了解 WeChat Server
            </span>
        ...
        <SubCard
          ...
          subTitle={
            <span>
              用以推送报警信息，
              <a href="https://github.com/cubeofcube-dev/message-pusher" target="_blank" rel="noreferrer">
                点击此处
              </a>
              了解 Message Pusher
            </span>
