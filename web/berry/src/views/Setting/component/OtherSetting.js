...
const OtherSetting = () => {
  ...
  const openGitHubRelease = () => {
    window.location = 'https://github.com/cubeofcube-dev/one-api/releases/latest';
  };

  const checkUpdate = async () => {
    const res = await API.get('https://api.github.com/repos/cubeofcube-dev/one-api/releases/latest');
