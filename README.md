...
<p align="center">
  <a href="https://github.com/cubeofcube-dev/one-api#部署">部署教程</a>
  ·
  <a href="https://github.com/cubeofcube-dev/one-api#使用方法">使用方法</a>
  ·
  <a href="https://github.com/cubeofcube-dev/one-api/issues">意见反馈</a>
  ·
  <a href="https://github.com/cubeofcube-dev/one-api#截图展示">截图展示</a>
  ·
  <a href="https://openai.justsong.cn/">在线演示</a>
  ·
  <a href="https://github.com/cubeofcube-dev/one-api#常见问题">常见问题</a>
  ·
  <a href="https://github.com/cubeofcube-dev/one-api#相关项目">相关项目</a>
  ·
...
22. 支持用户管理，支持**多种用户登录注册方式**：
    ...
    + 微信公众号授权（需要额外部署 [WeChat Server](https://github.com/cubeofcube-dev/wechat-server)）。
23. 支持主题切换，设置环境变量 `THEME` 即可，默认为 `default`，欢迎 PR 更多主题，具体参考[此处](./web/README.md)。
24. 配合 [Message Pusher](https://github.com/cubeofcube-dev/message-pusher) 可将报警信息推送到多种 App 上。
...
如果启动失败，请添加 `--privileged=true`，具体参考 https://github.com/cubeofcube-dev/one-api/issues/482 。

如果上面的镜像无法拉取，可以尝试使用 GitHub 的 Docker 镜像，将上面的 `justsong/one-api` 替换为 `ghcr.io/cubeofcube-dev/one-api` 即可。
...
### 手动部署
1. 从 [GitHub Releases](https://github.com/cubeofcube-dev/one-api/releases/latest) 下载可执行文件或者从源码编译：
   ```shell
...
详见 [#175](https://github.com/cubeofcube-dev/one-api/issues/175)。

如果部署后访问出现空白页面，详见 [#97](https://github.com/cubeofcube-dev/one-api/issues/97)。
...
1. 首先 fork 一份代码。
2. 进入 [Zeabur](https://zeabur.com?referralCode=cubeofcube-dev)，登录，进入控制台。
